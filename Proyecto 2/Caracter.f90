...
MODULE CaracterModule
    ...
    TYPE, PUBLIC :: Caracter
        CHARACTER(LEN=20) :: valor         ! Representa el carácter
        CHARACTER(LEN=12) :: tipo          ! Tipo del carácter
        INTEGER :: posicionFila            ! Fila donde se encuentra el carácter
        INTEGER :: posicionColumna         ! Columna donde se encuentra el carácter
        CHARACTER(LEN=30) :: token         ! Token asociado al carácter
        INTEGER :: correlativo             ! Número correlativo del carácter
        CHARACTER(LEN=100) :: descripcion  ! Breve descripción del carácter
    END TYPE Caracter
