PROGRAM Main
    ...
    USE LexicoThree  ! Usamos el módulo LexicoThree para agregar 'Léxico' a la lista
    IMPLICIT NONE
    ...
    ! Imprimir la lista con 'Léxico' agregado
    CALL imprimir_lista_con_lexico(lista_lexico)
